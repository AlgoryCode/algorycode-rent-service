...
class RentalRevenueEurTest {
  ...
  void optionsTotal_sumsNonNullPrices() {
    ...
    VehicleOptionDefinition da = new VehicleOptionDefinition();
    da.setPrice(new BigDecimal("10.25"));
    a.setVehicleOptionDefinition(da);
    RentalOption b = new RentalOption();
    VehicleOptionDefinition db = new VehicleOptionDefinition();
    db.setPrice(null);
    b.setVehicleOptionDefinition(db);
    RentalOption c = new RentalOption();
    VehicleOptionDefinition dc = new VehicleOptionDefinition();
    dc.setPrice(new BigDecimal("2.75"));
    c.setVehicleOptionDefinition(dc);
    opts.add(a);
    opts.add(b);
    opts.add(c);
    r.setOptions(opts);
  ...
  void totalRentalRevenueEur_scalesToTwoDecimalsHalfUp() {
    ...
    VehicleOptionDefinition od = new VehicleOptionDefinition();
    od.setPrice(new BigDecimal("0.015"));
    o.setVehicleOptionDefinition(od);
