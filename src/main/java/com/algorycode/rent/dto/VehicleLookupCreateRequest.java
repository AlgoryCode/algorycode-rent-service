...
/**
 * @param code İsteğe bağlı; boş veya null ise sunucu {@code labelTr} üzerinden benzersiz kod
 *     üretir.
 */
public record VehicleLookupCreateRequest(
    @Size(max = 32)
        @Pattern(
            ...
            message =
                "Kod en fazla 32 karakter; yalnız harf, rakam, tire ve alt çizgi veya boş bırakın.")
        String code,
